...
다음 JSON 형식으로만 응답하세요:
{
  ...
  "storyContent": "해당 제품의 역사적 기원과 문화적 배경을 바탕으로 3-4문장의 깊이 있는 스토리를 작성하세요. 제품 카테고리의 역사적 기원이나 지역 전통을 언급하고, 그 전통이 현대에 어떻게 재해석되었는지 설명하며, 만원요리가 이 제품을 선택한 특별한 이유를 포함하고, 고객이 이 제품을 통해 경험할 수 있는 감정적 가치를 담아 완성하세요. ${data.characteristics ? `특히 이 제품의 고유한 특성인 '${data.characteristics}'을 스토리에 자연스럽게 녹여서 제품만의 차별점을 강조하세요.` : ''}",
  "why1Title": "가장 강력한 구매 이유 (고객 페인포인트 해결)",
  "why1Text": "구체적인 혜택과 차별점 설명 (숫자/데이터 포함시 신뢰도 UP)${data.characteristics ? ` 특히 '${data.characteristics}' 특성을 고객 혜택으로 연결하여 설명하세요.` : ''}",
  "why2Title": "두번째 구매 이유 (경쟁제품 대비 우위)",
  "why2Text": "왜 다른 제품이 아닌 이 제품인지 명확히${data.characteristics ? ` '${data.characteristics}' 특성이 경쟁제품과 어떻게 다른지 강조하세요.` : ''}",
  "why3Title": "세번째 구매 이유 (사회적 증명/권위)",
  "why3Text": "38만 구독자의 선택, 리뷰, 인증 등 신뢰 요소",
  "how1Title": "기본 활용법 (즉시 실행 가능)",
  "how1Text": "누구나 쉽게 따라할 수 있는 구체적 방법${data.characteristics ? ` '${data.characteristics}' 특성을 살린 기본 활용법을 포함하세요.` : ''}",
  "how2Title": "프로 활용법 (특별한 경험)",
  "how2Text": "제품 가치를 200% 끌어올리는 꿀팁${data.characteristics ? ` '${data.characteristics}' 특성을 최대한 활용하는 고급 노하우를 제시하세요.` : ''}",
